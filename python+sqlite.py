...
def add():
    ...
    #获取输入，只接受正确格式的数据
    while True:
        record = input("Please input name,sex,age,department,telephone,qq(Q/q to return:)/n")
        ...
        sql = 'INSET INTO addressList(name,sex,age,department,telephone,qq)VAlUES("'
    ...
    while True:
        ...
        try:
            ...
            if not exist(recordId):
                ...
                doSql(sql)
                print('\tYou have delted a record.')
        except:
